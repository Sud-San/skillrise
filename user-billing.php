            ...
            <div class="container relative mt-6">
                <div class="grid md:grid-cols-12 grid-cols-1 gap-6">
                    ...
                    <div class="lg:col-span-8 md:col-span-8">
                        <div class="p-6 rounded-lg shadow-sm shadow-gray-100 dark:shadow-gray-800 bg-white dark:bg-gray-900">
                            <h6 class="text-gray-400">The following addresses will be used on the checkout page by default.</h6>
                            <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                                <div class="">
                                    <div class="flex items-center mb-4 justify-between">
                                        <h5 class="font-semibold">Billing Address:</h5>
                                        <a href="#" class="text-primary text-lg"><i class="ri-edit-line"></i></a>
                                    </div>
                                    <div class="pt-4 border-t border-gray-100 dark:border-gray-800">
                                        <p class="text-md font-medium mb-2">Calvin Carlo</p>

                                        <ul class="list-none">
                                            <li class="flex">
                                                <i class="ri-map-pin-line me-2 align-middle text-xl"></i>
                                                <p class="text-gray-400">C/54 Northwest Freeway, Suite 558, <br> Houston, USA 485</p>
                                            </li>

                                            <li class="flex mt-1">
                                                <i class="ri-phone-line me-2 align-middle text-xl"></i>
                                                <p class="text-gray-400">+123 897 5468</p>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    <div class="flex items-center mb-4 justify-between">
                                        <h5 class="font-semibold">Shipping Address:</h5>
                                        <a href="#" class="text-primary text-lg"><i class="ri-edit-line"></i></a>
                                    </div>
                                    <div class="pt-4 border-t border-gray-100 dark:border-gray-800">
                                        <p class="text-md font-medium mb-2">Calvin Carlo</p>

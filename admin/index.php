...
<body>
    <div class="wrapper">
        ...
        <div class="page-content">
            <div class="page-container">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="card hero-banner text-white border-0 overflow-hidden shadow">
                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div
                                ...
                                <div class="dropdown">
                                    <a href="#" class="arrow-none card-drop" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div
                                class="card-header d-flex justify-content-between align-items-center border-bottom border-dashed">
                                <h4 class="header-title">Popular Courses</h4>
                                <a href="manage-course.php" class="btn btn-sm btn-soft-primary">View All Courses</a>
                            </div>
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table table-hover table-nowrap table-centered mb-0">
                                        ...
                                        <tbody>
                                            <?php
                                            $popular_courses = mysqli_query($conn, "SELECT c.course_id, c.course_title, c.course_thumbnail, c.price, c.course_status, cat.category_name, t.tutor_name, COUNT(e.enrollment_id) as enroll_count 
                                                FROM course_tbl c 
                                                LEFT JOIN enrollments_tbl e ON c.course_id = e.course_id 
                                                JOIN category_tbl cat ON c.category_id = cat.category_id 
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center gap-3">
                                                            <img src="../assets/images/<?php echo $course['course_thumbnail']; ?>"
                                                                alt="" class="avatar-md rounded shadow-sm">
                                                            <div>
                                                                <h6 class="mb-1 fw-bold">
                                                                    <?php echo $course['course_title']; ?>
                                                                </h6>
                                                                <small class="text-muted">ID:
                                                                    #<?php echo $course['course_id']; ?></small>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-center"><?php echo $course['category_name']; ?></td>
                                                    <td class="text-center"><?php echo $course['tutor_name']; ?></td>
                                                    <td class="text-center">
                                                        <span class="badge bg-soft-info text-info rounded-pill px-3">
                                                            <?php echo number_format($course['enroll_count']); ?> Students
                                                        </span>
                                                    </td>
                                                    <td class="text-center fw-bold">
                                                        <?php echo $currency . number_format($course['price']); ?>
                                                    </td>
                                                    <!-- <td class="text-center">
                                                ...
                                                <tr>
                                                    <td colspan="4" class="text-center">
                                                        <div class="text-center py-3">
                                                            ...
                                                            <h6 class="fw-bold">No Recent Enrollments</h6>
                                                            <p class="text-muted small">All enrollments are up to date</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                $pending_q = mysqli_query($conn, "SELECT c.*, t.tutor_name FROM course_tbl c 
                                    JOIN tutor_tbl t ON c.tutor_id = t.tutor_id 
                                    WHERE c.course_status = 0 LIMIT 5");
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: '#054b40',
                    backgroundColor: 'rgba(5, 75, 64, 0.1)',
                    fill: true,
                    tension: 0.4,
                    borderWidth: 3,
                    pointRadius: 4,
                    pointBackgroundColor: '#fff',
                    pointBorderColor: '#054b40',
                    pointBorderWidth: 2
                }]
            },
            options: {
        ...
        new Chart(document.getElementById('categoryChart'), {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#054b40', '#086d5d', '#10c469', '#f59e0b', '#3b82f6', '#ec4899'],
                    borderWidth: 0,
                    cutout: '80%'
                }]
            },
        ...
        spark('studentSparkline', '#054b40', [<?php echo implode(',', $student_spark); ?>]);

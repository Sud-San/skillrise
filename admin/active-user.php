...
<head>
    <meta charset="utf-8" />
    <title>Active Users | <?php echo $company_name; ?></title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header border-bottom border-dashed">
                                <h4 class="header-title mb-2">Manage Active Users</h4>
                                <p class="text-muted mb-0">
                                    Manage List of Activated Users
                                </p>
                            </div>
                            <div class="card-body">
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            Swal.fire({
                                ...
                                window.location.href = "active-user.php";
                            });

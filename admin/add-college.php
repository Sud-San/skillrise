    ...
    if (!empty($_GET['id'])) {
        ...
        if (!empty($duplicate_fields)) {
            ...
            $insert = "INSERT INTO cllg_tbl 
                (clg_name, clg_slug, clg_email, clg_contact, clg_address, city_id, clg_website, clg_logo, clg_description)
                VALUES (
                '$clg_name', '$clg_slug', '$clg_email', '$clg_contact', '$clg_address', '$city_id',
                '$clg_website', '$logo_name', '$clg_description')";

            if (mysqli_query($conn, $insert)) {
                $alert_js = "Swal.fire({icon:'success', title:'Inserted!', text:'College inserted successfully.'})
                             .then(()=>{window.location='all-college.php';});";
            } else {
                ...
                <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control select2" data-toggle="select2" name="city_id" required>

        ...
        if ($stmt) {
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                try {
                    ...
                    if (file_exists(__DIR__ . '/assets/images/logo-dark.png')) {
                        $mail->addEmbeddedImage(__DIR__ . '/assets/images/logo-dark.png', 'companylogo');
                        $logoHtml = '<img src="cid:companylogo" width="200" style="margin-bottom:15px;">';
                    } else {
                        $logoHtml = '<h2 style="color:#10b981; margin-bottom:15px;">TutorPanel</h2>';
                    }
                    
                    $mail->isHTML(true);
                    
                    // Content
                    $mail->Subject = "Password Reset OTP Code - TutorPanel";
                    $mail->Body = '
                        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 10px;">
                            ...
                            <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
                                ...
                                <p style="color: #666; line-height: 1.6;">We received a request to reset your password for your TutorPanel account.</p>
                                ...
                                <p style="color: #666; line-height: 1.6;">Enter this code on the verification page to reset your password.</p>
                                <div style="margin-top: 30px; padding: 15px; background: #fff3cd; border-left: 4px solid #ffc107; border-radius: 5px;">
                                    <p style="margin: 0; color: #856404; font-size: 14px;">⚠️ If you didn\'t request this password reset, please ignore this email or contact support if you have concerns.</p>
                                </div>
                                <p style="margin-top: 30px; color: #666;">Best regards,<br><strong style="color: #10b981;">TutorPanel Team</strong></p>
                            </div>
                            <div style="text-align: center; margin-top: 20px; color: #999; font-size: 12px;">
                                <p>&copy; ' . date('Y') . ' TutorPanel. All rights reserved.</p>
                            </div>
                        </div>
                    ';
...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .input-wrap:focus-within .input-icon { color:var(--emerald); }
            ...
            <form action="" method="POST">
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <input type="email" id="email" name="email" class="form-input" placeholder="you@institution.edu" required/>
                    </div>
                </div>

                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <span class="toggle-pw" onclick="togglePassword('new_password', 'eye1')">
                            <svg id="eye1" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrap">
                        ...
                        <span class="toggle-pw" onclick="togglePassword('confirm_password', 'eye2')">
                            <svg id="eye2" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
                            </svg>
                        </span>
                    </div>

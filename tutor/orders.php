                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <div class="d-flex gap-2">
                                                ...
                                                <!-- Add Order Button -->
                                                <button class="btn add-order-btn" data-bs-toggle="modal"
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table id="datatable"
                                            ...
                                            <tbody>
                                                <?php for ($i = 0; $i < 20; $i++) {
                                                    $isChecked = ($i % 3 != 0) ? 'checked' : ''; // Mix of active/inactive
                                                    ?>
                                                    <tr>
                                                        <td>#12598</td>
                                                        <td>IMAGE</td>
                                                        <td class="text-start">
                                                            <div class="user-cell">
                                                                <i class="fa-solid fa-circle-info user-profile"
                                                                    title="View Profile" data-name="Abhinav Choudhary"
                                                                    data-role="Software Developer"
                                                                    data-location="ADAJAN SURAT-09"
                                                                    data-email="choudharyabhinav004@gmail.com"
                                                                    data-phone="1234567890" data-language="English"
                                                                    data-address="ADAJAN SURAT-09"
                                                                    data-courses='["PHP Essentials","Unix Power","Advance C"]'
                                                                    data-degree="B.Sc. (Bachelor of Science)"
                                                                    data-certificates='["CSS Developer Certificate","JavaScript Developer Certificate","Project Management Certificate"]'>
                                                                </i>
                                                        ...
                                                        <td>5</td>
                                                        <td>39%</td>
                                                        <td>Bhavyaa Chotalia</td>
                                                        <td>
                                                            <div class="d-flex justify-content-center">
                                                                <div class="form-check form-switch custom-switch">
                                                                    <input class="form-check-input status-switch"
                                                                        type="checkbox"
                                                                        id="flexSwitchCheck<?php echo $i; ?>" <?php echo $isChecked; ?>>
                                                                    <label class="form-check-label"
                                                                        for="flexSwitchCheck<?php echo $i; ?>"></label>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <a class="text-primary edit-btn" href="#" data-bs-toggle="modal"
                                                                data-bs-target="#editModal"><i
                                                                    class="fa-solid fa-pen me-2"></i></a>
                                                            <a class="text-danger delete-btn" href="#"><i
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel"><i class="fa-solid fa-plus me-2"></i>Add New Order</h5>
                    ...
                    <form id="addForm">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="error-message" id="addNameError"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="addEmail" class="form-label">Email <span
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="addPhone" class="form-label">Phone <span
                                        class="text-danger">*</span></label>
                                <input type="tel" class="form-control" id="addPhone">
                                <div class="error-message" id="addPhoneError"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="addCourse" class="form-label">Course Name <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="addCourse">
                                <div class="error-message" id="addCourseError"></div>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="addEnrolled" class="form-label">Enrolled Courses <span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="addEnrolled" min="0">
                                <div class="error-message" id="addEnrolledError"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="addProgress" class="form-label">Progress (%) <span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="addProgress" min="0" max="100">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="addTutor" class="form-label">Tutor Name <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="addTutor">
                                <div class="error-message" id="addTutorError"></div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="addOrder"><i class="fa-solid fa-save me-2"></i>Add
                        Order</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="editCourse" class="form-label">Course Name <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="editCourse">
                                <div class="error-message" id="editCourseError"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="editEnrolled" class="form-label">Enrolled Courses <span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="editEnrolled" min="0">
                                <div class="error-message" id="editEnrolledError"></div>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="editProgress" class="form-label">Progress (%) <span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="editProgress" min="0" max="100">
                                <div class="error-message" id="editProgressError"></div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="editTutor" class="form-label">Tutor Name <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="editTutor">
                                <div class="error-message" id="editTutorError"></div>
                            </div>
                        </div>

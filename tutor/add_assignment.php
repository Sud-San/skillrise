...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!move_uploaded_file($tmpName, $targetPath)) {
        ...
        $query = "INSERT INTO assignment_tbl 
              (course_id, tutor_id, title, file_url, status, created_at)
              VALUES
              ('$course_id', '{$_SESSION['tutor_id']}', '$assignment_name', '$fileName', '$status', NOW())";
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="toggle-row">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="assignment_status"
                                            id="assignmentStatus" checked>
                                    </div>
                                </div>
                            </div>

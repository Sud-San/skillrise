...
// Fetch payment details, ensuring it belongs to the logged-in user
$paymentStmt = $conn->prepare("
    ...
    WHERE p.user_payment_id = ? AND p.user_id = ?
");
$paymentStmt->bind_param("ii", $payment_id, $user_id_session);
$paymentStmt->execute();
                                    ...
                                    <div class="mt-6 md:mt-0 md:w-56 text-start">
                                        ...
                                        <ul class="list-none text-gray-400">
                                            <li class="flex mt-3">
                                                ...
                                                <span
                                                    class=""><?= e($payment['tutor_name']) ?: 'SkillRise Tutor' ?></span>
                                            </li>
                                            <li class="flex mt-3">
                                ...
                                <table class="w-full text-start text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        <tr class="bg-transparent dark:bg-transparent">
                                            ...
                                            <td class="text-end px-6 py-4">₹ <?= number_format($payment['amount'], 2) ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

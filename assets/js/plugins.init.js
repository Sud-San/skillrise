/* Template Name: Eclass - Dream Class
   Author: Shreethemes
...
try {
    const Default = {
        alwaysOpen: false,
        activeClasses: 'bg-white dark:bg-gray-900 text-primary',
...
try {
    const Default = {
        ...
        inactiveClasses: 'hover:text-primary dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800',
        onShow: () => { }
    }

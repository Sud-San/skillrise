...
<style>
    ...
    #topnav {
        background-color: #054b40 !important;
    }
            ...
            <?php if (isset($_SESSION['user_name']) && isset($_SESSION['user_role'])): ?>
                ...
                <div class="profile-dropdown">
                    <button type="button" class="profile-btn">
                        <span class="profile-btn-inner">
                            <img src="<?php echo $_SESSION['user_profile_pic']; ?>" alt="Profile">
                        </span>
                    </button>

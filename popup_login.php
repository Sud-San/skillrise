...
<div id="loginPopup" style="display:none; position:fixed; top:50%; left:50%; 
  ...
  <!-- ❌ Close Button -->
  <span id="closePopup" style="position:absolute; top:10px; right:15px; font-size:20px; color:#333; 
  ...
  <form id="popupLoginForm">
    ...
    <a href="forgot_password.php"
      style="display:block; color:green; text-decoration:none; font-size:0.9rem; text-align:left;">
      Forgot Password?
    </a><br>

    <button type="submit" style="width:100%; padding:10px; background:green; border:none; color:white;

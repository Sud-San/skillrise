...
<body class="text-gray-900 dark:text-white dark:bg-gray-900">
        ...
        <div class="container relative">
            <div class="grid grid-cols-1 text-center mt-10">
                ...
                <ul class="tracking-[0.5px] inline-block mt-2">
                    ...
                    <li class="inline-block font-medium uppercase duration-500 text-xs ease-in-out text-white dark:text-white" aria-current="page">About Us</li>
                </ul>
            </div><!--end grid-->
        </div><!--end container-->
    </section><!--end section-->
    ...
    <section class="relative lg:py-24 py-16">
                ...
                <div class="lg:col-span-6 md:col-span-7">
                    <div class="relative">
                        <div class="relative md:shrink-0 lg:me-0 me-10">
                            <img class="object-cover md:w-96 w-84 h-full rounded-lg rounded-ss-[60px] shadow-sm shadow-gray-100 dark:shadow-gray-800" src="assets/images/1.jpg" alt="<?php echo $company_name; ?> Platform">
                        </div>
                        ...
                        <div class="absolute bottom-15 lg:end-6 end-0">
                            ...
                            <div class="relative md:shrink-0">
                                <div class="p-2 rounded-lg rounded-ee-[60px] bg-white dark:bg-gray-900">
                                    <img class="object-cover size-48 rounded-lg rounded-ee-[60px] shadow-sm shadow-gray-100 dark:shadow-gray-800" src="assets/images/2.jpg" alt="Learning Experience">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container relative lg:mt-24 mt-16">
            ...
            try {
                // Get all categories
                $categoryQuery = "SELECT category_id, category_name, category_code FROM category_tbl WHERE category_status = 1";
            ...
            <div style="position: relative; margin-top: 1.5rem;">
                ...
                <!-- Prev Button -->
                <button id="abCatPrev" type="button" style="position:absolute; left:-20px; top:50%; transform:translateY(-50%); z-index:20; width:40px; height:40px; border-radius:50%; background:#fff; border:1px solid #e5e7eb; box-shadow:0 2px 8px rgba(0,0,0,0.1); display:flex; align-items:center; justify-content:center; cursor:pointer; color: inherit;">
                ...
                <div style="overflow: hidden;">
                    <div id="abCatTrack" style="display:flex; gap:20px; transition: transform 0.4s ease;">
                        ...
                        <div class="ab-cat-card" style="flex: 0 0 calc(25% - 15px); min-width: 0;">
                            <div class="group bg-white dark:bg-gray-900 rounded-lg shadow shadow-gray-200 dark:shadow-gray-800 p-6 flex flex-col h-auto transition hover:shadow-lg duration-300">
                                <div class="flex-grow text-center flex flex-col justify-start">
                                    <img src="assets/images/<?php echo $meta['img']; ?>" 
                                         alt="<?php echo $name; ?>" 
                                    ...
                                    <p class="text-sm text-gray-400 mb-1">
                                        <?php echo $courseCount; ?> Course<?php echo $courseCount != 1 ? 's' : ''; ?> Available
                                    </p>
                                </div>
                                <div class="mt-4 text-center">
                                    <a href="courses-by-language.php?cat_id=<?php echo urlencode($categoryId); ?>" class="inline-block text-sm text-primary hover:underline">
        ...
        <div class="container relative md:mt-24 mt-16">
            ...
            <div style="position: relative; margin-top: 1.5rem;">
                ...
                <!-- Prev Button -->
                <button id="abTutorPrev" type="button" style="position:absolute; left:-20px; top:50%; transform:translateY(-50%); z-index:20; width:40px; height:40px; border-radius:50%; background:#fff; border:1px solid #e5e7eb; box-shadow:0 2px 8px rgba(0,0,0,0.1); display:flex; align-items:center; justify-content:center; cursor:pointer; color: inherit;">
                    <i class="ri-arrow-left-s-line" style="font-size:20px;"></i>
                </button>
                    ...
                    <div id="abTutorTrack" style="display:flex; gap:24px; transition: transform 0.4s ease;">
                        ...
                        <div class="ab-tutor-card" style="flex: 0 0 calc(25% - 18px); min-width: 0;">
                            <div class="group text-center">
                                <div class="relative mx-auto rounded-full overflow-hidden border-4 border-white shadow-md shadow-gray-100 dark:shadow-gray-800 duration-500" style="width: 130px; height: 130px;">
                                    <?php
                ...
                <!-- Next Button -->
                <button id="abTutorNext" type="button" style="position:absolute; right:-20px; top:50%; transform:translateY(-50%); z-index:20; width:40px; height:40px; border-radius:50%; background:#fff; border:1px solid #e5e7eb; box-shadow:0 2px 8px rgba(0,0,0,0.1); display:flex; align-items:center; justify-content:center; cursor:pointer; color: inherit;">
                    <i class="ri-arrow-right-s-line" style="font-size:20px;"></i>
                </button>
            </div>
